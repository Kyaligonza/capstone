...
class MyapphsbkTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.producer_auth_header = {'Authorization':'{}'.format(bearer_tokens['executive_producer'])}
        self.director_auth_header = {'Authorization':'{}'.format(bearer_tokens['casting_director'])}
        self.assistant_auth_header = {'Authorization':'{}'.format(bearer_tokens['casting_assistant'])}
